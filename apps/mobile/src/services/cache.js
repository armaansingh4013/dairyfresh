const SESSION_KEY = "dairy-mobile:session";
const CART_KEY = "dairy-mobile:cart";
const CACHE_PREFIX = "dairy-mobile:cache:";
...
export async function saveJson(key, value) {
  try {
    ...
    // no-op: cache should never block UX
  }
}
...
export async function saveCart(items) {
  return saveJson(CART_KEY, items);
}

export async function clearCart() {
  return removeKey(CART_KEY);
}
